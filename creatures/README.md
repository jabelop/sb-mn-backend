# creatures
Creatures service for mn backend application.
...
Once you have all running, and the **Players service** migrations performed, you can run the Migrations file from the `peristence/migrations` folder to get the data base initialized.
...
2024-12-04 14:32:45.682 [main] INFO  Application - Responding at http://0.0.0.0:8083
```
